        ...
        public class Area
        {
            ...
            public class Province
            {
                ...
                public static void PopulateProvinceLists()
                {
                    ...
                    area = Area.Find("East Ered Nimrais Foothills");
                    ...
                    area = Area.Find("West Ered Nimrais Foothills");
            ...
            public static void PopulateAreaLists()
            {
                ...
                region.AreaList.Add(new Area("East Anfalas", new Color32(255, 0, 255, 255)));
                region.AreaList.Add(new Area("Belfalas", new Color32(0, 255, 255, 255)));

                region.AreaList.Add(new Area("East Ered Nimrais Foothills", new Color32(102, 0, 0, 255)));
                region.AreaList.Add(new Area("West Ered Nimrais Foothills", new Color32(0, 102, 0, 255)));
                region.AreaList.Add(new Area("West Anfalas", new Color32(0, 0, 102, 255)));
